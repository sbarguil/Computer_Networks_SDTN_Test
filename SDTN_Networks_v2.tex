...
\begin{figure}
	\centering
		\includegraphics[width=\linewidth]{figs/l3vpn_workflow_3.png}
	\caption{Messages Interchanged for IP multi-domain L3VPN service creation.}
	\label{FIG:l3vpn_workflow}
\end{figure}

\Cref{FIG:l3vpn_workflow} depicts the workflow used by the SDTN to create and retrieve the services on the IP SDNc. Each creation block represents a set of  creation (POST) and retriveal (GET) operations. The five blocks of requests depicted corresponds to: 
